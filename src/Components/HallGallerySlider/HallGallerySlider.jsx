...
const HallGallerySlider = ({ data }) => {
  ...
  return (
    <div className="hall-gallery-slider">
      <img src={tree1} alt="Dekorativna slika" className='hgs-tree1-img parallax' data-speedx="0.01" data-speedy="0.015" data-speedz="0.01" data-rotation="0.01" />
      <div className="hgs-tree1-overlay"></div>
      <img src={tree2} alt="Dekorativna slika" className='hgs-tree2-img parallax' data-speedx="0.034" data-speedy="0.026" data-speedz="0.067" data-rotation="0.049" />
