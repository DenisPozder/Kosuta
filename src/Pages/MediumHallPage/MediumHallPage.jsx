...
import { MediumHallGallery, MediumHallGallerySlider } from '../../HallData/GallerySliderData'
import HallGallerySlider from '../../Components/HallGallerySlider/HallGallerySlider'

const MediumHallPage = () => {
  ...
  return (
    <HallLayout>
        <section className="page-section">
          <HallsHeroImages slides={MediumHallGallery} />
          <HallGallerySlider data={MediumHallGallerySlider} />
        </section>
    </HallLayout>
  )
}

export default MediumHallPage