    ...
    <div className="all-halls-hero">
        ...
        <div className="ahh-wrap">
            <div className="ahh-content">
                ...
                <p className='ahh-desc'>Pogledajte sve naše sale, i odaberite pravu salu za vaš poseban dan. Na raspolaganju su vam sale sa kapacitetom od 80 do 400 gostiju, sa prilagodljivim minijima, sve u zavisnosti od vaših potreba.</p>
