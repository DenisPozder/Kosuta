...
import { SmallHallGallery, SmallHallGallerySlider } from '../../HallData/GallerySliderData'
  ...
  return (
    <HallLayout>
        <section className="page-section">
          <HallsHeroImages slides={SmallHallGallery} />
          <HallGallerySlider data={SmallHallGallerySlider} />
        </section>
    </HallLayout>
  )
}
